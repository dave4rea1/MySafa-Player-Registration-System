...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['select_league'])) {
    $selectedLeagueId = $_POST['league'];

    // Fetch the league name from the database
    ...
    // Set the session variable with the league name
    $_SESSION['SelectedLeague'] = $leagueName;

    header("Location: Clubs.php"); // Redirect to the next step
    exit();
}
...
<html>
<head>
    <title>Select League - MYSAFA</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <!-- process timeline end -->
            ...
            <h2 class="text-center">Select League</h2>
                        ...
                        <tbody>
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    echo "<tr>";
                                    echo "<td><input type='radio' name='league' value='" . $row['LeagueID'] . "' required></td>";
                                ...
                                echo "<tr><td colspan='5'>No leagues available.</td></tr>";
                            }
                            ?>
                        </tbody>
                    </table>
                </div>
                <button type="submit" name="select_league" class="btn btn-primary">Next</button>
            </form>
        </div>
    </div>
